...
class NormalFace:
    ...
    def execute(self, obj):
        ...
        VL = start+vector*obj.Length
        norm = Part.makeLine(start,VL)
        r1 = obj.Length/10
        hc = r1*3
        cone = Part.makeCone(0,r1,hc,VL,start-VL)
...
def MakeNormal():
    ...
    try:
        ...
        sub1 = What.SubElementNames[1]
        print (sub0)
        print (sub1)
        
        if sub0[0:4] == "Face" and sub1[0:6] == "Vertex":
        ...
        try:
            ...
            if sub0[0:4] == "Face":
                ...
                print("Select a face or/and a vertex, then run the macro.")
