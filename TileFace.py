...
#10/06/2021 added PedestrianWalk and upgrated sharp for small square
#31/12/2011 upgrated sharp for checker and square
...
class TileFace:
   def __init__(self, obj, link):
        obj.addProperty("App::PropertyInteger","U","Parameters","").U = 6  
        ...
        obj.addProperty("App::PropertyFloat","Height","Parameters","Height").Height = 0.0
        obj.addProperty("App::PropertyFloat","HeightRandom","Parameters","Randomise the tiles").HeightRandom = 0.0
        obj.addProperty("App::PropertyBool","Solid","Parameters","Either oulined or solid with thickness").Solid = True
        obj.addProperty("App::PropertyBool","Limit","Parameters","Try to limit the tile on the plane face").Limit = False
        ...
        obj.Style = ["Points","Hatch","Squares","Squares Streched","Small Squares","Checkers","Diamonds","Honeycomb","PedestriansWalk"]
